...
class PlaySoundsViewController: UIViewController {
    ...
    func setUserInterfaceToPlayMode(_ isPlayMode: Bool) {
        ...
        //Check Volume
        if let volSlider = UserDefaults.standard.value(forKey: "sliderVol") as? Float {
            sliderView.value = volSlider
        }
    }
    ...
    @IBAction func sliderDidMove(_ sender: UISlider) {
        ...
        UserDefaults.standard.set(sliderView.value, forKey: "sliderVol")

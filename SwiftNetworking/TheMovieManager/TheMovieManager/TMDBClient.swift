...
class TMDBClient : NSObject {
    ...
    func taskForGETMethod(_ method: String, parameters: [String:AnyObject], completionHandlerForGET: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        parameters[TMDBClient.ParameterKeys.ApiKey] = TMDBClient.Constants.ApiKey as AnyObject?
        
        //Url Request
        let request = URLRequest(url: TMDBClient.tmdbURLFromParameters(parameters as [String:AnyObject], withPathExtension: method))
        
        let task = TMDBClient.sharedInstance().session.dataTask(with: request) { (data, response, error) in
    ...
    func taskForPOSTMethod(_ method: String, parameters: [String:AnyObject], jsonBody: String, completionHandlerForPOST: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        parameters[TMDBClient.ParameterKeys.ApiKey] = TMDBClient.Constants.ApiKey as AnyObject?
         ...
         var request = URLRequest(url: TMDBClient.tmdbURLFromParameters(parameters as [String:AnyObject], withPathExtension: method))
